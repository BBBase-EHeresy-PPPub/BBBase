...
Each Star Player has its own profile, complete with all of the Characteristics, Skills and Traits that they possess. The profile will also have a 'Plays For' section, which will list one or more of the Leagues & Traits Star Players can play for.

Star Players can only play for teams that have the same League as them. In some situations, a Star Player may not have a League listed, and may have a special rule listed instead. In these situations, the Star Player can only play for a team that also has that special rule.

***Example one:** Griff Oberwald can play for teams from the Old World Classic, and so a team must have chosen the Old World Classic League when their Team Roster was drafted in order to hire Griff Oberwald.*

***Example two:** A Star Player with the Favoured of Khorne special rule can only play for teams that have the Favoured of Khorne special rule, and not those that have chosen any other type of Favoured of... such as Nurgle or Slaanesh.*
