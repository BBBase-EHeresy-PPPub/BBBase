...
### AGILITY SKILL  
*(icon: leaping player silhouette)*

### DEVIOUS SKILL  
*(icon: stylized sneering eyes)*

### GENERAL SKILL  
*(icon: clenched fist)*

### MUTATION SKILL  
*(icon: tentacled mutation)*

### PASSING SKILL  
*(icon: spinning football)*
...
| :----: | :----: | ------------------ | ------------------- | ------------------ | --------------------- | ------------------ | ---------------- |
|  1–3   |   1    | Dodge              | Eye Gouge           | Dauntless          | Claws                 | Cannoneer         | Arm Bar          |
|  1–3   |   2    | Diving Catch       | Dive                | Block              | Big Hand              | Fumblerooski      | Brawler          |
|  1–3   |   3    | Diving Tackle      | Fumblerooski        | Fend               | Disturbing Presence*  | Cloud Burster     | Break Tackle     |
|  1–3   |   4    | Dodge              | Lethal Fidget       | Frenzy*            | Extra Arms            | Dump-off          | Bullseye         |
...
This Skill can be used whilst a player is Prone.  
