**TIER 1**
![](../media/teams/BBUnderworldDenizens2.jpg){ width=918 height=948 }
...
| 0-3  | Skaven Clanrat *(Lineman, Skaven)*     | 7   | 3   | 3+  | 4+  | 8+  | • [Animosity (Goblin)]                                                                                                                          | G M D   | A S       | 50K  |
| 0-1  | Skaven Thrower *(Skaven, Thrower)*     | 7   | 3   | 3+  | 2+  | 8+  | • [Animosity (Goblin)]<br>• [Pass]<br>• [Sure Hands]                                                                                            | G M P   | A D S     | 80K  |
| 0-1  | Gutter Runner *(Runner, Skaven)*       | 9   | 2   | 2+  | 4+  | 8+  | • [Animosity (Goblin)]<br>• [Dodge]<br>• [Stab]                                                                                                 | A G M D | S         | 85K  |
| 0-1  | Skaven Blitzer *(Blitzer, Skaven)*     | 8   | 3   | 3+  | 4+  | 9+  | • [Animosity (Goblin)]<br>• [Block]<br>• [Strip Ball]                                                                                           | G M S   | A P       | 90K  |
