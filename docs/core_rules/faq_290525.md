## DESIGNER'S COMMENTARY MAY 2024
...
**Q:** When a player dodges while being Marked by a player with Tentacles, do they move into the new square, resolve any effects (such as picking up a ball) and then resolve the
Tentacles roll? **(p.78)**
